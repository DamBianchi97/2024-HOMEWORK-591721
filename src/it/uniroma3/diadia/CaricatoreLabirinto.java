...
public class CaricatoreLabirinto {
	...
	/* prefisso della riga contenente le specifiche dei personaggi "strega" */
	private static final String PERSONAGGI_MARKER_STREGA = "Streghe:";

	/* prefisso della riga contenente le specifiche dei personaggi "cane" */
	private static final String PERSONAGGI_MARKER_CANE = "Cani:";

	/* prefisso della riga contenente le specifiche dei personaggi "mago" */
		...
		for(String specifiche : separaStringheAlleVirgole(specificheUscite)) {
			try (Scanner scannerDiLinea = new Scanner(specifiche)) 	{	
				while (scannerDiLinea.hasNext()) {
					...
					Direzioni dir = Direzioni.valueOf(scannerDiLinea.next());
